 ...
 * @ORM\Entity(repositoryClass=AuthorTranslationsRepository::class)
 */
class AuthorTranslations
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Author::class, inversedBy="translations",  cascade={"persist"})
